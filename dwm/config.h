...
static char normbordercolor[]       = "#B57614";
static char normfgcolor[]           = "#FFFF07"; // unselected tags
static char selfgcolor[]            = "#b16286"; // selected tag text title
static char selbordercolor[]        = "#D79921"; // Main window border
static char selbgcolor[]            = "#000000"; // current tag title bg
...
const char *spcmd1[] = {TERMINAL, "-n", "spterm", "-g", "90x15", NULL };
const char *spcmd2[] = {TERMINAL, "-n", "spcalc", "-f", "monospace:size=16", "-g", "50x20", "-e", "bc", "-lq", NULL };
const char *spcmd3[] = {TERMINAL, "-n", "sphtop", "-g", "120x15", "-e", "htop",  NULL };
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,		XK_ntilde,	spawn,		SHCMD("Gimp") },
	...
	// { MODKEY|ShiftMask,		XK_l,		spawn,      	SHCMD("lia") },
	...
	{ MODKEY,			XK_F8,		spawn,		SHCMD(TERMINAL " -e mbsync javierpacheco@mail.com && mw -Y") },
